       ...
       <div className='form-wrapper' id="form-wrapper">
         ...
         <form  onSubmit={addSuplier} >
           ...
           <div className='password'>
             ...
             <input type={type} name='password'  value={password} onChange={updatePwd} />
             <span className="password__show text-right" onClick={handleClick}>  <svg className="bi bi-eye" width="2em" height="1.5em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
