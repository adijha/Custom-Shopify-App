            ...
            <div className="box">
              <div className="icon">
                ...
                <div className="info">
                  ...
                  <p>
                    <i className="fa fa-envelope" aria-hidden="true" /> &nbsp; Support@support.com
                    <br />
                    <br />
                  </p>
                </div>
            ...
            <div className="box">
              <div className="icon">
                ...
                <div className="info">
                  ...
                  <p>
                    <i className="fa fa-mobile" aria-hidden="true" /> &nbsp; (+91)-9624XXXXX
                    <br />
                    <br />
                    <i className="fa fa-mobile" aria-hidden="true" /> &nbsp;  (+91)-756706XXXX
                  </p>
                </div>
              </div>
              <div className="space" />
            ...
            <div className="box">
              <div className="icon">
                ...
                <div className="info">
                  ...
                  <p>
                    <i className="fa fa-map-marker" aria-hidden="true" /> &nbsp; 15/3 Junction Building
                    <br/>"ABC New Krishna Krupa", State - 110000.
                  </p>
                </div>
              </div>
              <div className="space" />
