          ...
          <div className='row' style={{ float: 'left', marginTop: '-20rem' }}>
            <div className='col-sm-5'>
              <p className='promo-title'>
                <b>Welcome to Melis</b>xpress
              </p>
              <p style={{ textAlign: 'justify' }}>
                Discover large variety of viral products for your store in
                seconds, add them to your store and we will ship them directly
                to your customers. <b>No inventory, no risk. </b>
                Let's get started!
              </p>
              <br />
              <button
      ...
      <section id='pricing' style={{ padding: '60px 0' }}>
        ...
        <div className='container text-center'>
          <div className='row text-center'>
            ...
            <div className='col-md-6'>
              <p className='switch-para' style={{ float: 'left' }}>
                {plan}
              </p>
            </div>
          </div>
          ...
          <div className='row'>
              ...
              <div className='panel panel-success'>
                ...
                <ul className='list-group list-group-flush text-center tickMark'>
                  <li className='list-group-item'>
                    <i className=''></i>
                    <b>200</b> Orders per month
                  </li>
                  <li className='list-group-item'>
                    <i className='icon-ok text-danger' />
                    Real time analytics
                  </li>
                  <li className='list-group-item'>
                    <i className='icon-ok text-danger' />
                  ...
                  <li className='list-group-item'>
                    <i className='icon-ok text-danger' />
                    Customized logo invoice
                  </li>
                  <li className='list-group-item'>
                    <i className='icon-ok text-danger' />
                    <b>50 cents/order </b>Branded thank you letter
                  </li>
                  <li className='list-group-item'>
                    <i className='icon-ok text-danger' />
                    <b>Paid </b>weekly audit & call
                  </li>
                </ul>
            ...
            <div className='col-md-4'>
              <div className='panel panel-info'>
                ...
                <ul className='list-group list-group-flush text-center tickMark'>
                  <li className='list-group-item'>
                    <i className=''></i>
                    <b>Unlimited</b> Orders per month
                  </li>
                  <li className='list-group-item'>
                    <i className='icon-ok text-danger' />
                    Real time analytics
                  ...
                  <li className='list-group-item'>
                    <i className='icon-ok text-danger extra' />
                    Sample ordering
                  </li>
                  <li className='list-group-item'>
                    <i className='icon-ok text-danger extra' />
            ...
            <div className='col-md-4'>
              <div className='panel panel-warning'>
                <div className='panel-heading'>
                  <h4 className='text-center'>Plus +</h4>
                </div>
                <div className='panel-body text-center'>
                  <p className='lead'>
                    <strong>${plus}</strong>
